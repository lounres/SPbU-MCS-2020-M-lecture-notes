...
\begin{document}
    ...
    \begin{proof}
        \begin{enumerate}
            ...
            \item Понятно, что $X \subseteq \overline{X}$, а значит $I(\overline{X}) \subseteq I(X)$. Покажем обратное.
                \todo[inline]{Дописать.}
    ...
    \begin{lemma}
        Пусть $R$ --- кольцо, $I$ --- радикальный идеал в $R$, $\pi: R \to \overline{R} := R/I, f \mapsto f \pmod{I}$. Тогда имеется взаимнооднозначное соответствие между множеством радикальных идеалов $J \supseteq I$ в $R$ и множеством радикальных идеалов $\mathfrak{A}$ в $\overline{R}$, заданное отображениями $J \mapsto \overline{J} := J/I$ и $\mathfrak{A} \mapsto \pi^{-1}(\mathfrak{A})$.
    \end{lemma}

    \begin{proof}
        \todo[inline,color=blue]{``Легкое упражнение.''}
    \end{proof}
