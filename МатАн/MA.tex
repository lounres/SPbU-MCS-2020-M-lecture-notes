...
\begin{document}
    ...
    \begin{proof}
        Предположим противное, т.е. существуют взаимно простые $m \in \ZZ$ и $n \in \NN\setminus\{0\}$, что $(\frac{m}{n})^2 = 2$. Тогда $m^2 = n^2$. Очевидно, что тогда $m^2 \vdots 2$, значит $m\vdots 2$, значит $m\vdots 4$, значит $n^2 \vdots 2$, значит $n \vdots 2$, значит $n$ и $m$ не взаимно просты, так как делятся на $2$ --- противоречие.
    \end{proof}
