...
\author{Юрий Сергеевич Белов\\ВК: @ybelov}
\date{}
...
\begin{document}
    ...
    Определение натуральных чисел сложно, рассмтривать его не будем. Важно также иметь в виду натуральные числа с операциями сложения и умножения.
    ...
    \begin{definition}[аксиоматический подход]
        ...
        \begin{itemize}
            ...
            \item[$B$)] $0 \preccurlyeq a \wedge 0 \preccurlyeq b \Rightarrow 0 \preccurlyeq ab$
        \end{itemize}
