...
\begin{document}
    ...
    \begin{proof}
        Из условия на $X$ следует, что $\NN \cap X$ индуктивно. Тогда из определения $\NN$ следует, что $\NN \subseteq \NN \cap X$, значит $X = \NN$.
    \end{proof}
    ...
    \begin{corollary}
        $\forall \forall n \in \NN$ верно $n \subseteq \NN$.
    \end{corollary}
